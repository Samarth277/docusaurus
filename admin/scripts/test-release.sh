...
# Build skeleton website with the new version
...
echo "The website with the to-be-published packages was successfully built in the 'test-website' directory."
